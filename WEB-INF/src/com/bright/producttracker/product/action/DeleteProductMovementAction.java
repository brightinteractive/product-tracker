 ...
 * DeleteProductMovementAction
 *
 * Contains the DeleteProductMovementAction class.
 */
 ...
 * @version d1
 */
public class DeleteProductMovementAction extends Bn2Action
{
 ...
 ------------------------------------------------------------------------
	 */
	{
		...
		{						
			...
			m_productManager.deleteProductMovement(dbTransaction, lId);
		...
		{			
			 m_logger.error("Exception in DeleteProductMovementAction:" + bn2e.getMessage());
		...
		finally
		{
			 ...
			 {
				  m_logger.error("Exception commiting transaction in DeleteProductMovementAction:" + sqle.getMessage());
