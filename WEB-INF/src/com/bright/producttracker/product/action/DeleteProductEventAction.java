 ...
 * @version d1
 */
public class DeleteProductEventAction extends Bn2Action implements CommonConstants, ProductConstants
{
	 ...
	 */
	{
		...
		try
		{
			...
			long lEventId = getLongParameter(a_request, k_sParam_EventId);
			
			if (lProductId > 0 && lEventId > 0)
			{
				// Save:
				m_productManager.removeProductEvent(null, lProductId, lEventId);	
			}
